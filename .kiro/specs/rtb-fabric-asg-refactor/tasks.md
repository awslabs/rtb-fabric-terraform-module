...
- [x] 1. Update variable structure for ASG managed endpoints
...
- [x] 2. Create ASG discovery role management infrastructure
- [x] 2.1 Add local values for ASG discovery role computation
...
- [x] 2.2 Add default role name variable
...
- [x] 2.3 Create ASG discovery role resource
...
- [x] 2.4 Create ASG discovery permissions policy
...
- [x] 3. Update responder gateway resource configuration
- [x] 3.1 Modify CloudControlAPI resource for ASG endpoints
...
- [x] 3.2 Update resource dependencies
  - Add ASG discovery role and policy to `depends_on` list
  - Ensure proper creation order for ASG-related resources
  - _Requirements: 2.4, 3.1_

- [x] 4. Add validation for manual setup mode
- [x] 4.1 Create validation data sources
...
- [x] 4.2 Implement validation checks
...
- [x] 5. Update example configuration
- [x] 5.1 Migrate ASG example to new structure
...
- [x] 5.2 Add example documentation
...
- [x] 6. Clean up legacy terminology and improve error handling
- [x] 6.1 Update resource naming consistency
...
- [x] 6.2 Enhance error messages and validation
